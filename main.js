...
door.position.z = 1;
scene.add( door );
const handlebasegeometry = new THREE.SphereGeometry( 0.05,16,5);
const handlebasematerial = new THREE.MeshLambertMaterial( { color: 0xFFD700 } );
...
handlebase.rotation.y = Math.PI/4;
handlebase.position.x = 2.24;
handlebase.position.y = -0.1;
handlebase.position.z = 1.35;
scene.add( handlebase );
...
pc.position.z = 2.5;
scene.add( pc );
const monitorgeometry = new THREE.CylinderGeometry( 0.1, 0.3, 0.3, 4 );
...
monitor.position.x = 2;
monitor.position.y = -0.15;
monitor.position.z = 2.5;
scene.add( monitor );
const monitorscreengeometry = new THREE.PlaneGeometry( 0.35, 0.35 );
...
monitorscreen.position.x = 1.85;
monitorscreen.position.y = -0.15;
